 ...
 *     tags:
 *       - Research Docs
 *     summary: Auto-generated POST endpoint for /api/research-docs
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/researchDocumentUpload",
      new URLSearchParams({
    ...
    console.error("research-docs error:", (err instanceof Error ? err.message : String(err)));
