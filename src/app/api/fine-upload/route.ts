 ...
 *     tags:
 *       - Fine Upload
 *     summary: Auto-generated POST endpoint for /api/fine-upload
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/examinations/withheldResult/FineChallanUploadPage",
      new URLSearchParams({
    ...
    console.error("fine-upload error:", (err instanceof Error ? err.message : String(err)));
