 ...
 *     tags:
 *       - Swf Requisition
 *     summary: Auto-generated POST endpoint for /api/swf-requisition
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/event/swf/loadRequisitionPage",
      new URLSearchParams({
    ...
    console.error("swf-requisition error:", (err instanceof Error ? err.message : String(err)));
