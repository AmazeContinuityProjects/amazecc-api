 ...
 *     tags:
 *       - Ir Outbound
 *     summary: Auto-generated POST endpoint for /api/ir-outbound
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/ir/student/visitingRequest",
      new URLSearchParams({
    ...
    console.error("ir-outbound error:", (err instanceof Error ? err.message : String(err)));
