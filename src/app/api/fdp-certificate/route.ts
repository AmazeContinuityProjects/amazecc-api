 ...
 *     tags:
 *       - Fdp Certificate
 *     summary: Auto-generated POST endpoint for /api/fdp-certificate
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/events/ASC/EventsCertificateDownload",
      new URLSearchParams({
    ...
    console.error("fdp-certificate error:", (err instanceof Error ? err.message : String(err)));
