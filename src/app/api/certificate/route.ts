 ...
 *     tags:
 *       - Certificate
 *     summary: Auto-generated POST endpoint for /api/certificate
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/examinations/certificate/CertificateStudent",
      new URLSearchParams({
    ...
    console.error("certificate error:", (err instanceof Error ? err.message : String(err)));
