 ...
 *     tags:
 *       - Mess Feedback
 *     summary: Auto-generated POST endpoint for /api/mess-feedback
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("mess-feedback error:", (err instanceof Error ? err.message : String(err)));
