 ...
 *     summary: Auto-generated POST endpoint for /api/registration-schedule
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/examinations/hostelDetails",
      new URLSearchParams({
    ...
    console.error("registration-schedule error:", (err instanceof Error ? err.message : String(err)));
