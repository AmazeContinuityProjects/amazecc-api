 ...
 *     tags:
 *       - Coursework Reg
 *     summary: Auto-generated POST endpoint for /api/coursework-reg
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/CourseworkRegistration",
      new URLSearchParams({
    ...
    console.error("coursework-reg error:", (err instanceof Error ? err.message : String(err)));
