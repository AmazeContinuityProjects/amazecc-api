 ...
 *     tags:
 *       - Thesis Submission
 *     summary: Auto-generated POST endpoint for /api/thesis-submission
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/thesisSubmission",
      new URLSearchParams({
    ...
    console.error("thesis-submission error:", (err instanceof Error ? err.message : String(err)));
