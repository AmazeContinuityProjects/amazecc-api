 ...
 *     tags:
 *       - Transcript
 *     summary: Auto-generated POST endpoint for /api/transcript
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/alumni/alumniTranscriptPageControl",
      new URLSearchParams({
    ...
    console.error("transcript error:", (err instanceof Error ? err.message : String(err)));
