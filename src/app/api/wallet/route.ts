 ...
 *     tags:
 *       - Wallet
 *     summary: Auto-generated POST endpoint for /api/wallet
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
import { parseWallet } from "@/lib/parsers/wallet";
...
export async function POST(req: Request) {
  try {
    ...
    const data = parseWallet(resp.data);
