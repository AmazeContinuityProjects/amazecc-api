 ...
 *     tags:
 *       - Scholar Leave
 *     summary: Auto-generated POST endpoint for /api/scholar-leave
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/scholar/leave/request",
      new URLSearchParams({
    ...
    console.error("scholar-leave error:", (err instanceof Error ? err.message : String(err)));
