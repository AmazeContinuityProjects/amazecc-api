 ...
 *     tags:
 *       - Acknowledgement
 *     summary: Auto-generated POST endpoint for /api/acknowledgement
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/admissions/AcknowledgmentView",
      new URLSearchParams({
    ...
    console.error("acknowledgement error:", (err instanceof Error ? err.message : String(err)));
