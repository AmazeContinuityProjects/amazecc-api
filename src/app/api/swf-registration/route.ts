/**
 * @openapi
 * /api/swf-registration:
 *   post:
 *     tags:
 *       - Swf Registration
 *     summary: Auto-generated POST endpoint for /api/swf-registration
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/event/swf/loadEventRegistration",
      new URLSearchParams({
    ...
    console.error("swf-registration error:", (err instanceof Error ? err.message : String(err)));
