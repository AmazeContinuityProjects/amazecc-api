 ...
 *     tags:
 *       - Research Templates
 *     summary: Auto-generated POST endpoint for /api/research-templates
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/reseachScholarTempleteView",
      new URLSearchParams({
    ...
    console.error("research-templates error:", (err instanceof Error ? err.message : String(err)));
