 ...
 *     tags:
 *       - Research Profile
 *     summary: Auto-generated POST endpoint for /api/research-profile
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("research-profile error:", (err instanceof Error ? err.message : String(err)));
