 ...
 *     tags:
 *       - Meeting Info
 *     summary: Auto-generated POST endpoint for /api/meeting-info
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/scholarsMeetingView",
      new URLSearchParams({
    ...
    console.error("meeting-info error:", (err instanceof Error ? err.message : String(err)));
