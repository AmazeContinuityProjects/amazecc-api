 ...
 *     tags:
 *       - Fees Intimation
 *     summary: Auto-generated POST endpoint for /api/fees-intimation
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/finance/getFeesIntimation",
      new URLSearchParams({
    ...
    console.error("fees-intimation error:", (err instanceof Error ? err.message : String(err)));
