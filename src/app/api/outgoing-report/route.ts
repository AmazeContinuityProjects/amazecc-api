 ...
 *     tags:
 *       - Outgoing Report
 *     summary: Auto-generated POST endpoint for /api/outgoing-report
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("outgoing-report error:", (err instanceof Error ? err.message : String(err)));
