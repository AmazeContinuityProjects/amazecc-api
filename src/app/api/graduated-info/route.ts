 ...
 *     tags:
 *       - Graduated Info
 *     summary: Auto-generated POST endpoint for /api/graduated-info
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/admissions/doGetPassedOutInformation",
      new URLSearchParams({
    ...
    console.error("graduated-info error:", (err instanceof Error ? err.message : String(err)));
