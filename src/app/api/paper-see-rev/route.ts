 ...
 *     tags:
 *       - Paper See Rev
 *     summary: Auto-generated POST endpoint for /api/paper-see-rev
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/examinations/paperSeeing/PaperSeeing",
      new URLSearchParams({
    ...
    console.error("paper-see-rev error:", (err instanceof Error ? err.message : String(err)));
