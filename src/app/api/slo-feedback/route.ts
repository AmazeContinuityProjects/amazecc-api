 ...
 *     tags:
 *       - Slo Feedback
 *     summary: Auto-generated POST endpoint for /api/slo-feedback
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/academics/Others/doSloStudentFeedback",
      new URLSearchParams({
    ...
    console.error("slo-feedback error:", (err instanceof Error ? err.message : String(err)));
