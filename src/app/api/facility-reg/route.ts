 ...
 *     tags:
 *       - Facility Reg
 *     summary: Auto-generated POST endpoint for /api/facility-reg
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("facility-reg error:", (err instanceof Error ? err.message : String(err)));
