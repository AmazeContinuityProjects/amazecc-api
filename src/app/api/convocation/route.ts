 ...
 *     tags:
 *       - Convocation
 *     summary: Auto-generated POST endpoint for /api/convocation
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("convocation error:", (err instanceof Error ? err.message : String(err)));
