 ...
 *     tags:
 *       - Ept Schedule
 *     summary: Auto-generated POST endpoint for /api/ept-schedule
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("ept-schedule error:", (err instanceof Error ? err.message : String(err)));
