 ...
 *     tags:
 *       - Internship
 *     summary: Auto-generated POST endpoint for /api/internship
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/internship/InternshipRegistration",
      new URLSearchParams({
    ...
    console.error("internship error:", (err instanceof Error ? err.message : String(err)));
