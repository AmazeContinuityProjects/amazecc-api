 ...
 *     tags:
 *       - Monthly Report
 *     summary: Auto-generated POST endpoint for /api/monthly-report
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/researchWkProgressReport",
      new URLSearchParams({
    ...
    console.error("monthly-report error:", (err instanceof Error ? err.message : String(err)));
