 ...
 *     tags:
 *       - Research Award
 *     summary: Auto-generated POST endpoint for /api/research-award
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/monthlyAwardApplication",
      new URLSearchParams({
    ...
    console.error("research-award error:", (err instanceof Error ? err.message : String(err)));
