/**
 * @openapi
 * /api/fdp-registration:
 *   post:
 *     tags:
 *       - Fdp Registration
 *     summary: Auto-generated POST endpoint for /api/fdp-registration
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/events/ASC/EventsRegistration",
      new URLSearchParams({
    ...
    console.error("fdp-registration error:", (err instanceof Error ? err.message : String(err)));
