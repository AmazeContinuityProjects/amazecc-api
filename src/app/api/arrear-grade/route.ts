...
export async function POST(req: Request) {
  try {
    ...
    const INIT_URL = "/vtop/examinations/arrearRegistration/StudentArrearGradeView";
    const DATA_URL = "/vtop/examinations/arrearRegistration/doStudentArrearGradeView";
