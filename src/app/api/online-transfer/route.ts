 ...
 *     tags:
 *       - Online Transfer
 *     summary: Auto-generated POST endpoint for /api/online-transfer
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/finance/getOnlineTransfer",
      new URLSearchParams({
    ...
    console.error("online-transfer error:", (err instanceof Error ? err.message : String(err)));
