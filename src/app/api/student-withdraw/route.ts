/**
 * @openapi
 * /api/student-withdraw:
 *   post:
 *     tags:
 *       - Student Withdraw
 *     summary: Auto-generated POST endpoint for /api/student-withdraw
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("student-withdraw error:", (err instanceof Error ? err.message : String(err)));
