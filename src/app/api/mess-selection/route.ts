 ...
 *     tags:
 *       - Mess Selection
 *     summary: Auto-generated POST endpoint for /api/mess-selection
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/hostels/counselling/mess/registration",
      new URLSearchParams({
    ...
    console.error("mess-selection error:", (err instanceof Error ? err.message : String(err)));
