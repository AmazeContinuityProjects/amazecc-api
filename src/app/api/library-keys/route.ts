 ...
 *     tags:
 *       - Library Keys
 *     summary: Auto-generated POST endpoint for /api/library-keys
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/library/studentScanningRequestKeys",
      new URLSearchParams({
    ...
    console.error("library-keys error:", (err instanceof Error ? err.message : String(err)));
