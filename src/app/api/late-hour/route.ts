 ...
 *     tags:
 *       - Late Hour
 *     summary: Auto-generated POST endpoint for /api/late-hour
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/hostels/late/hour/student/request/1",
      new URLSearchParams({
    ...
    console.error("late-hour error:", (err instanceof Error ? err.message : String(err)));
