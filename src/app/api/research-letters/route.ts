/**
 * @openapi
 * /api/research-letters:
 *   post:
 *     tags:
 *       - Research Letters
 *     summary: Auto-generated POST endpoint for /api/research-letters
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/researchLettersStudentView",
      new URLSearchParams({
    ...
    console.error("research-letters error:", (err instanceof Error ? err.message : String(err)));
