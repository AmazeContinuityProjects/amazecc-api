/**
 * @openapi
 * /api/programme-migration:
 *   post:
 *     tags:
 *       - Programme Migration
 *     summary: Auto-generated POST endpoint for /api/programme-migration
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/admissions/programmeMigration",
      new URLSearchParams({
    ...
    console.error("programme-migration error:", (err instanceof Error ? err.message : String(err)));
