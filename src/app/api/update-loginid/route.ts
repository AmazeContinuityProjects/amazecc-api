 ...
 *     tags:
 *       - Update Loginid
 *     summary: Auto-generated POST endpoint for /api/update-loginid
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/controlpanel/ChangePreferredUser",
      new URLSearchParams({
    ...
    console.error("update-loginid error:", (err instanceof Error ? err.message : String(err)));
