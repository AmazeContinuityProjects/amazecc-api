 ...
 *     tags:
 *       - Regulation
 *     summary: Auto-generated POST endpoint for /api/regulation
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/academics/council/CouncilRegulationView/new",
      new URLSearchParams({
    ...
    console.error("regulation error:", (err instanceof Error ? err.message : String(err)));
