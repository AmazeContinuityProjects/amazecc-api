 ...
 *     tags:
 *       - Outcome Set
 *     summary: Auto-generated POST endpoint for /api/outcome-set
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/outcome/set/studentRegistrationPage",
      new URLSearchParams({
    ...
    console.error("outcome-set error:", (err instanceof Error ? err.message : String(err)));
