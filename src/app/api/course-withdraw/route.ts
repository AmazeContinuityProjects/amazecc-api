 ...
 *     tags:
 *       - Course Withdraw
 *     summary: Auto-generated POST endpoint for /api/course-withdraw
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/academics/withdraw/courseWithdraw",
      new URLSearchParams({
    ...
    console.error("course-withdraw error:", (err instanceof Error ? err.message : String(err)));
