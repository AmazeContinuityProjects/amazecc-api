/**
 * @openapi
 * /api/scholar-verification:
 *   post:
 *     tags:
 *       - Scholar Verification
 *     summary: Auto-generated POST endpoint for /api/scholar-verification
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/research/scholarDataVerificationProcessByScholar",
      new URLSearchParams({
    ...
    console.error("scholar-verification error:", (err instanceof Error ? err.message : String(err)));
