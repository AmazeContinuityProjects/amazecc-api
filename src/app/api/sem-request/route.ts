 ...
 *     tags:
 *       - Sem Request
 *     summary: Auto-generated POST endpoint for /api/sem-request
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    const resp = await client.post(
      "/vtop/admissions/semTransactionPageControllerGeneral",
      new URLSearchParams({
    ...
    console.error("sem-request error:", (err instanceof Error ? err.message : String(err)));
