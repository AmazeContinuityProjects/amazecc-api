 ...
 *     tags:
 *       - Question Preview
 *     summary: Auto-generated POST endpoint for /api/question-preview
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
export async function POST(req: Request) {
  try {
    ...
    console.error("question-preview error:", (err instanceof Error ? err.message : String(err)));
